...
var Kalendae = function (targetElement, options) {
	...
	while (j--) {
		...
		util.make('div', {'class':classes.previousMonth}, $title);          //previous button
		util.make('a', {'class':classes.nextYear}, $title);               //next button
		util.make('div', {'class':classes.nextMonth}, $title);              //next button
...
Kalendae.prototype = {
	...
	draw : function draw() {
		...
		this.settings.cb && this.settings.cb()
	}
};
